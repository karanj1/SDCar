...
def conv(input, kernel, biases, k_h, k_w, c_o, s_h, s_w,  padding="VALID", group=1):
    ...
    '''
    c_i = input.get_shape()[-1]   #http://stackoverflow.com/questions/36966316/how-to-get-the-dimensions-of-a-tensor-in-tensorflow-at-graph-construction-time   #-1 = last dimension
    assert c_i % group == 0     #color_input
    assert c_o % group == 0      #color_output
    ...
    if tf.__version__ < "1.0.0":
        ...
        if group == 1:
            ...
            input_groups = tf.split(input, group, 3)        #https://www.tensorflow.org/api_docs/python/tf/split    #axis=3
